// auth
exports.register = "insert into user (userId, password, nickName) values (?, ?, ?); show warnings;"
...
exports.listFriend = "select userId, nickName, isOnline, isAttend from friendlist where origin_userId = ?"
