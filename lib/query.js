...
exports.invitePlan = "insert into plan_participation(pid, userId, isAccepted) select ?, ?, ? from dual where not exists (select * from `user` where `userId` = ? and `planInviteOption` = false) ;"
