...
exports.getLocation = "select `nickName`, `latitude`, `longitude` from `participant_coordination` where `pid` = ? and `isAccepted` = true and `latitude` is not null and `longitude` is not null;"
